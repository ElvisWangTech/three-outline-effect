...
void main() {
    ...
    vUv = uv;
    sampleCoordS = uv + vec2(0.0, edgeThickness.w) * texelSize;
    sampleCoordE = uv + vec2(edgeThickness.w, 0.0) * texelSize;
    sampleCoordN = uv + vec2(0.0, -edgeThickness.w) * texelSize;
    sampleCoordW = uv + vec2(-edgeThickness.w, 0.0) * texelSize;
}